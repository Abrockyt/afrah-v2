...
export function createMaterials(renderer, quality = 'standard') {
  ...
  const stone=pbr('stone','#e3d9c9'), paving=pbr('paving','#c1b9aa',3), road=pbr('road','#737778',5), metal=pbr('metal','#54483b');
  metal.metalness=.88;metal.roughness=.34;metal.normalScale.setScalar(.045);
  const glass=new T.MeshPhysicalMaterial({color:'#a4b1b0',metalness:0,roughness:.12,ior:1.5,transmission:preset.transmission,thickness:.018,attenuationColor:'#c6d5ce',attenuationDistance:8,envMapIntensity:1.1,clearcoat:.2});
