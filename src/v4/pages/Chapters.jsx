...
const Building = lazy(() => import('../three/Building'));
...
function SculptureStory() {
  ...
  return <section className="v-sculpt" ref={ref} data-tone="graphite">
    <div className="v-sculpt-pin">
      ...
      {near && <Suspense fallback={null}><Sculpture progress={progress} tone="silver"/></Suspense>}
...
export function Neighbourhood() {
  ...
  return <>
    ...
    <section className="v-map-live" data-tone="white">
      ...
      <div className="v-map-live-stage"><Suspense fallback={null}><CityMap/></Suspense></div>
    </section>
...
function SunStudy() {
  ...
  return <section className="v-sun" ref={ref} data-tone="sky">
    <div className="v-sun-stage">{near && <Suspense fallback={null}><Building mode="sun" sun={sun}/></Suspense>}</div>
...
function Selector() {
  ...
  return <section className="v-selector" ref={ref} data-tone="night">
    <div className="v-selector-stage">
      {near && <Suspense fallback={null}><Building mode="select" selected={floor} onSelect={setFloor} onHover={setHover}/></Suspense>}
