...
export default function ArchitecturalPattern({ className = '' }) {
  ...
  return <svg className={`architectural-pattern ${className}`} viewBox="0 0 1440 1000" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
    <defs><linearGradient id={gradientId} x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#d8a78c" stopOpacity=".04"/><stop offset=".55" stopColor="#d8a78c" stopOpacity=".65"/><stop offset="1" stopColor="#d8a78c" stopOpacity=".06"/></linearGradient></defs>
